<template>
	<view>
		...
		<view class="cu-form-group">
			<picker @change="pickerChange" :value="complaint.reason" :range="picker">
				<view class="picker" style="display: flex;">
					...
					<view style="width: 5%;padding: 10rpx 0 0 5rpx;">
						<image src="../../../static/images/user/right.png" mode="" style="width: 30px;height: 20px;"></image>
					</view>
				</view>
			</picker>
		</view>
		...
		<view class="wanlian cu-bar tabbar foot flex flex-direction" style="margin-bottom: 20px;">
			<button class="cu-btn wanl-bg-redorange lg" @tap="submit" style="margin: 15rpx 0 0 6rpx;">发起举报</button>
		</view>
	</view>
</template>
