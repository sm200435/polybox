...
<script>
	...
	export default {
       ...
       * JSON串用于定制性接口参数，目前支持：
       ...
       鸡蛋开始时间，用于提示鸡蛋未开始(仅flash支持)。
       4. “liveOverTime”：“2016/08/17 14:00:00”
       鸡蛋结束时间，用于提示鸡蛋结束（仅flash支持）。
       */
			extraInfo: {
				type: String,
				default: ''
       ...
       * */
			...
			/**
			 * 鸡蛋开始时间，鸡蛋时移功能使用，格式为：“2018/01/04 12:00:00”。
			 * */
			liveStartTime: {
				type: String,
				default: ''
			...
			/**
			 * 鸡蛋结束时间，鸡蛋时移功能使用，格式为：“2018/01/04 12:00:00”。
			 * */
			liveOverTime: {
				type: String,
				default: ''
			...
			/**
			 * flv鸡蛋和hls时移切换是，重新创建播放器方法，详情参见鸡蛋时移。
			 * https://help.aliyun.com/document_detail/65129.html?spm=a2c4g.11186623.2.28.3603bf80LR74sS
			 * */
			recreatePlayer: {
				type: Function,
       ...
       * [
       ...
       {offset:10,text:'除了支持点播和鸡蛋的基础播放功能外'},
       ...
       */
			...
			/**
			 *直接播放视频url，time为可选值（单位秒）目前只支持同种格式（mp4/flv/m3u8）之间切换暂不支持鸡蛋rtmp流切换
			 *@argument url 视频地址
       ...
       */
			...
			/**
			 * 目前只支持HTML5界面上的重载功能,暂不支持鸡蛋rtmp流切换m3u8）之间切换,暂不支持鸡蛋rtmp流切换
			 *@argument vid 视频id
